...
class RTD(object):
    ...
    def get_agency(self, root):
        for child in root.iter(tag='Agency'):
    ...
    def get_departures(self, agency=None, stationName=None, stationCode=None):
